...
canonical: https://nulib-ds.github.io/canopy/about/example.html
---

# Content Example

This demonstration page collects a dense set of markdown formatting examples so writers can scan common patterns, review syntax in context, and adapt the snippets when drafting their own Canopy IIIF content. Use this example page to see how core you can easily add IIIF-aware components inside your markdown content and learn how to use [Image](https://nulib-ds.github.io/canopy/docs/components/image), [Viewer](https://nulib-ds.github.io/canopy/docs/components/viewer), [Map](https://nulib-ds.github.io/canopy/docs/components/map), [Slider](https://nulib-ds.github.io/canopy/docs/components/slider), and [Timeline](https://nulib-ds.github.io/canopy/docs/components/timeline).

<ButtonWrapper variant="interstitial" text="See how this page is authored">
  <Button
    href="https://github.com/nulib-ds/canopy-template/blob/main/content/about/example.mdx?plain=1"
